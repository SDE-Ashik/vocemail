...
def send_email(subject, body, sender, receiver):
    ...
    #email_username = 'akhilaanil944@gmail.com'
    #email_password = 'akhila766@'
...
# Usage example
send_email("Hello from Python", "This is the body of the email.", "satyamtiwari4430@digipodium.com", "akhilaanil881@gmail.com")
